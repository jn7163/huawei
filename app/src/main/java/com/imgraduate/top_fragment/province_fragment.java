...
public class province_fragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,Bundle savedInstanceState) {
        if (view == null){
            view = inflater.inflate(R.layout.fragment_province_fragment, null);
            initListView();
            loadedPages = 1;
        ...
        protected Boolean doInBackground(String... params) {
            ...
            try {
                ...
                for (Element div : divs){
                    if (div.attr("class").equals("jobList s_clear")){
                        ...
                        for (Element tr : trs){
                            if ((tr.attr("class") != null)&&(!tr.attr("class").equals(""))){
                                ...
                                map.put("detail", tr.select("b").html() + tr.select("td").get(1).html() + tr.select("td").get(2).html());
                                list.add(map);
                            }
                        }
                    }
